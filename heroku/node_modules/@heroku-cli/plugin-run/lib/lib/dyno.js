...
class Dyno extends stream_1.Duplex {
    ...
    _handle(localServer) {
        ...
        if (this.opts.listen) {
            ...
            let sshProc = child_process_1.spawn('ssh', params, { stdio });
    ...
    _env() {
        let c = this.opts.env ? helpers_1.buildEnvFromFlag(this.opts.env) : {};
        ...
        return data => {
            ...
            if (exitCode) {
                ...
                if (code === 0) {
                    ...
                    let err = new Error(`Process exited with code ${color_1.default.red(code.toString())}`);
                    err.exitCode = code;
                    this.reject(err);
                }
                return;
