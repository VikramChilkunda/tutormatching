...
class UserTest < ActiveSupport::TestCase
  def setup
    @tutee = Tutee.new(name: "Example Tutee", email: "tutee@example.com", gradYear: 2021, student_id: 999999, password: "password", password_confirmation: "password")
  end
